...
mkdir /mnt/hdd/hdd6/Docker_Volumes
mkdir /mnt/hdd/hdd6/Docker_Volumes/Lightning
mkdir /mnt/hdd/hdd6/Docker_Volumes/Lightning/Mainnet
mkdir /mnt/hdd/hdd6/Docker_Volumes/Lightning/Testnet
mkdir /mnt/hdd/hdd6/Docker_Volumes/Lightning/Simnet
